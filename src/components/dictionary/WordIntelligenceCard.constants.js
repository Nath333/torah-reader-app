/**
 * WordIntelligenceCard Constants & Cache Logic
 *
 * Extracted from WordIntelligenceCard.js for maintainability.
 * Contains display configuration constants, cross-refs caching, and helper utilities.
 *
 * @module WordIntelligenceCard.constants
 */
 ...
 */
export const getCardId = (word) => `vocab-${cleanHebrewWord(word)}`;
