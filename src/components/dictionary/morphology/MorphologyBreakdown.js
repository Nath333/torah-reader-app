// =============================================================================
// Morphology Breakdown Component
...
import { SEMANTIC_FIELD_DISPLAY } from '../WordIntelligenceCard/constants';
...
/**
 * Weak Verb Type Badge (פ"נ, ע"ו, ל"ה)
...
/**
 * Related Words from Same Root Section
 ...
 * Comprehensive verb pattern display
 */
 ...
 * Also shows verb grammar, confidence, and computed translation
 */
const MorphologyBreakdown = ({
  ...
  // Pattern-based translation for Aramaic verbs
  ...
  // Try Hebrew binyan detection if no Aramaic pattern
  ...
  // Root info lookup for related words
  ...
  return (
    <div className="morphology-breakdown morphology-pro">
      {/* Header with confidence badge and SRS button */}
      ...
      {/* Pattern, language, and V6 analysis badges */}
