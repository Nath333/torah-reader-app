/**
 * SugyaViewModes - View mode components for pattern display
 * Extracted from UnifiedSugyaAnalysis/index.js
 *
 * Components: FlowNode, FlowConnector, FlowView, TreeNode, TreeView,
 *             DiagramView, SummaryView, PatternDetailPanel
 */
